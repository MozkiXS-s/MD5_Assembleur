...
compute_hash:
    ...
    ; assume tous les segments dans le même segment
    cld
    push    rax
    push    rbx
    push    rcx
    ...
    ; Sauvegarde de la longueur du message
...
add_padding:
    ...
    ; Ajout de la longueur du message en bits
...
store_message_len:
    ...
    ; Initialisation des variables de hash
    pop     rdi
    mov     rax, INIT_A
    mov     [hash_a], rax
    mov     rax, INIT_B
...
block_loop:
    ...
    jne     backup_abcd
    mov     rsi, octets_fin  ; Basculer les buffers en fin de traitement
backup_abcd:
    push    qword [hash_d]
    push    qword [hash_c]
    push    qword [hash_b]
...
entree_test_1 db 'Lol', 0
entree_test_2 db 'Rocket', 0
entree_test_3 db 'EldenRing', 0
...
; Constantes et tables nécessaires pour l'algorithme de Hash modifié
...
; Variables de données pour le Hash
